    ...
    <div className='min-h-screen bg-gradient-to-br from-[#F9F5FF] via-[#F3EEFF] to-[#FDF4FF] flex items-center justify-center px-4 py-12'>
      <div className='w-full max-w-md'>
        ...
        <div className='text-center mb-8'>
          ...
          >
            <div className='w-12 h-12 rounded-full bg-gradient-to-br from-[#7C5CBF] to-[#C084F5] flex items-center justify-center mb-3 text-white'>
              <SparkleIcon />
            </div>
        ...
        <div className='bg-white rounded-3xl shadow-xl shadow-purple-100/60 border border-purple-100 p-8'>
          {/* Temp notice */}
          <div className='mb-5 bg-[#F9F5FF] border border-purple-200 text-[#7C5CBF] text-[12.5px] px-4 py-3 rounded-xl'>
            🔧 Demo mode — use <strong>test@test.com</strong> /{' '}
          ...
          {/* Google button — disabled until Firebase is ready */}
          <button
            type='button'
            disabled
            className='w-full flex items-center justify-center gap-3 py-3 border border-purple-100 rounded-xl text-[14px] font-medium text-[#B0A0CC] bg-[#FAF8FF] cursor-not-allowed'
          >
          ...
          <form onSubmit={handleLogin} className='space-y-4'>
            ...
            <div>
              <div className='flex items-center justify-between mb-1.5'>
                <label className='text-[13px] font-semibold text-[#4A3570]'>
                  Password
                </label>
                <Link
                  href='/forgot-password'
                  className='text-[12px] text-[#7C5CBF] hover:text-[#6A4DAD] no-underline'
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <p className='mt-6 text-center text-[13.5px] text-[#8470A8]'>
